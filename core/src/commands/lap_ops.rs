...
//!
//! Lap-aware math reads four things off the context: the per-lap bounds, the
//! sectors flattened across laps, the designated main lap, and the table
//! baseline row. Filling only the first of those is not a partial answer —
...
use crate::math::eval::MathLapContext;
